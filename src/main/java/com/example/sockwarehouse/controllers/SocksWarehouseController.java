...
public class SocksWarehouseController {
    ...
    @PostMapping
    private ResponseEntity<ResponseDto> accept(@RequestBody SockBatch socksBatch) {
    ...
    @PutMapping
    private ResponseEntity<ResponseDto> issuance(@RequestBody SockBatch socksBatch) {
    ...
    @GetMapping
    private ResponseEntity<ResponseDto> getCount(@RequestParam SockColor color,
    ...
    @DeleteMapping
    private ResponseEntity<ResponseDto> reject(@RequestBody SockBatch socksBatch) {
        int socksCount = socksWarehouseService.edit(socksBatch);
